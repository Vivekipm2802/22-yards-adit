...
const App: React.FC = () => {
  ...
  // âââ BROWSER BACK BUTTON SUPPORT âââ
  ...
  /* ââ URL params: ?transfer=BASE64_MATCH_STATE for device handoff ââ */
  ...
  /* ââ URL params: ?importMatch=BASE64 for cross-device match record sharing ââ */
  ...
  /* ââ URL params: ?spectate=CODE for spectator mode ââ */
  ...
  /* ââ URL params: ?transfer_id=MATCH_ID for Supabase-based score handoff ââ */
  ...
  /* ââ Transfer Confirmation state ââ */
  ...
  /* ââ transfer_id: Fetch match from Supabase and show confirmation overlay ââ */
  useEffect(() => {
  ...
  /* ââ Decode transfer data from URL and show confirmation ââ */
  useEffect(() => {
  ...
  /* ââ Transfer accepted: two-phase navigation to avoid AnimatePresence race ââ */
  ...
  /* ââ Import Match Record from shared link ââ */
  useEffect(() => {
  ...
  /* ââ Spectator mode: ?watch=MATCH_ID â saved as followed match, routed into app ââ */
  ...
  return (
    <AuthContext.Provider value={{ userData, login: handleLogin, logout: handleLogout }}>
      <div className="h-[100dvh] w-full bg-[#020617] text-white flex flex-col overflow-hidden relative font-sans">
        ...
        {/* TRANSFER SCORING CONFIRMATION â shown when receiver opens ?transfer= URL */}
        <AnimatePresence>
